...
export class ListPage {
  ...
  constructor(public loadingCtrl: LoadingController, public navCtrl: NavController, public navParams: NavParams, public proveedor:Proveedor1Provider,
...
ionViewDidLoad(){
  this.proveedor.obtenerDatos()
       ...
       .subscribe(
         ...
         console.log('Tigrezhito-traeDatos_1',data)
